...
import { X, Copy, ExternalLink, Check, ImagePlus } from "lucide-react";
...
const ListProductModal = ({ product, onClose }: ListProductModalProps) => {
  ...
  return (
    ...
    >
      <div
        className="bg-card border border-border rounded-2xl w-full max-w-5xl max-h-[95vh] overflow-y-auto"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-4 md:p-6">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-3">
                <div>
                  <Label htmlFor="lpm-cost">Supplier Cost ($)</Label>
                  <Input
                    id="lpm-cost"
                    type="number"
                    placeholder="0.00"
                ...
                <div>
                  <Label htmlFor="lpm-ship">Shipping Cost ($)</Label>
                  <Input
                    id="lpm-ship"
                    type="number"
                    placeholder="0.00"
                ...
                <div>
                  <Label htmlFor="lpm-fee">TikTok Referral Fee (%)</Label>
                  <Input
                    id="lpm-fee"
                    type="number"
            ...
            {/* Step-by-Step Guide */}
            <div className="space-y-2">
              <h3 className="font-semibold text-sm">How to List</h3>
